# HIGHLY based on: https://www.pyimagesearch.com/2017/04/17/real-time-facial-landmark-detection-opencv-python-dlib/

# USAGE
# python arm_facial_tracking_dlib.py --shape-predictor shape_predictor_68_face_landmarks.dat
# python arm_facial_tracking_dlib.py --shape-predictor shape_predictor_68_face_landmarks.dat --picamera 1
