	...
	for i in range(joystick_count):
		...
		for axis in range(axes_count):
			...
			if axis == 4 and abs(axis_value) >= 0.15:
				...
				mc.move_axis(mc.ax0_pos, mc.ax0_min_lim, mc.ax0_max_lim, mc.reduction_64, axis_value)
			...
			if axis == 1 and abs(axis_value) >= 0.15:
				mc.move_axis(mc.ax1_pos, mc.ax1_min_lim, mc.ax1_max_lim, mc.reduction_128, axis_value)
